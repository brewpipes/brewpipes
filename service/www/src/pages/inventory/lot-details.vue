  ...
  <v-container class="inventory-page" fluid>
    <v-card class="section-card">
      <v-card-title class="d-flex align-center">
        Lot details
        <v-spacer />
        <v-btn size="small" variant="text" :loading="loading" @click="loadLots">
          Refresh
        </v-btn>
      </v-card-title>
      <v-card-text>
            ...
            <v-row>
              <v-col cols="12" md="6">
                <v-card class="sub-card" variant="outlined">
                  ...
                  <v-card-text>
                    <div class="text-body-2 text-medium-emphasis" v-if="lotMaltDetail">
              ...
              <v-col cols="12" md="6">
                <v-card class="sub-card" variant="outlined">
                  ...
                  <v-card-text>
                    <div class="text-body-2 text-medium-emphasis" v-if="lotHopDetail">
              ...
              <v-col cols="12">
                <v-card class="sub-card" variant="outlined">
                  ...
                  <v-card-text>
                    <div class="text-body-2 text-medium-emphasis" v-if="lotYeastDetail">
