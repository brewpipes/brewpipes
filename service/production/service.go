...
func (s *Service) HTTPRoutes() []service.HTTPRoute {
	...
	return []service.HTTPRoute{
		...
		{Method: http.MethodGet, Path: "/recipes/{id}", Handler: auth(handler.HandleRecipeByID(s.storage, s.storage))},
		{Method: http.MethodPut, Path: "/recipes/{id}", Handler: auth(handler.HandleRecipeByID(s.storage, s.storage))},
		{Method: http.MethodDelete, Path: "/recipes/{id}", Handler: auth(handler.HandleRecipeByID(s.storage, s.storage))},
		...
		{Method: http.MethodPatch, Path: "/batches/{id}", Handler: auth(handler.HandleBatchByID(s.storage))},
		{Method: http.MethodDelete, Path: "/batches/{id}", Handler: auth(handler.HandleBatchByID(s.storage))},
		...
		{Method: http.MethodPatch, Path: "/vessels/{id}", Handler: auth(handler.HandleVesselByID(s.storage))},
